...
$checkPassword = mysqli_query($dbConnection, "SELECT * FROM users WHERE username='$username' AND password='$oldMd5'");
...
$query = mysqli_query($dbConnection, "UPDATE users SET password='$newMd5' WHERE username='$username'");
